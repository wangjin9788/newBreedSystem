...
public class MailUtils {
     ...
     * @param template
     */
    public void sendTemplateMail(String to, String subject, String content,String template){
        try {
            // 获得模板
            Template template1;
            template1 = freeMarkerConfigurer.getConfiguration().getTemplate(template);
            // 使用Map作为数据模型，定义属性和值
            Map<String,Object> model = new HashMap<>();
            model.put("mb",content);
